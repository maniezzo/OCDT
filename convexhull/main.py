...
if __name__ == "__main__":
   ...
   ax.set_xlabel(df.columns[d[0]], fontweight='bold')
   ax.set_ylabel(df.columns[d[1]], fontweight='bold')
   ax.set_zlabel(df.columns[d[2]], fontweight='bold')
   plt.show()
   ...
   # To test the point:
   idpoint=0
   print('Point is in the hull?', contained([c0[idpoint]],hull.equations))
